...
# http://127.0.0.1:8000
# docker build -t vksh-api:1.0 .
# docker run -p 8000:8000 --name mycontainername vksh-api


#kubectl create deployment web-server --image=southamerica-east1-docker.pkg.dev/vksh-04030613/vksh-docker/vksh:version1
#kubectl expose deployment vksh-api --type LoadBalancer --port 80 --target-port 800